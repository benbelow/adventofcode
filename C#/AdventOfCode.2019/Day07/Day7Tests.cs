...
namespace AdventOfCode._2019.Day07
{
    ...
    public class Day07Tests
    {
        ...
        {
            Day07.GetMaximumThrust(program).Should().Be(expectedThrust);
        }

        [Test]
        public void Part1()
        {
            Day07.Part1().Should().Be(95757);
        }
        ...
        public void MaximumThrustWithFeedbackLoop(string program, int expectedThrust)
        {
            Day07.GetMaximumThrustWithFeedback(program).Should().Be(expectedThrust);
        }

        [Test]
        public void Part2()
        {
            Day07.Part2().Should().Be(4275738);
        }
    }
}