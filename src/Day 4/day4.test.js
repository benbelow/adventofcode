const isValidPassphrase = require('./day4').isValidPassphrase;
const isValidPartTwoPassphrase = require('./day4').isValidPartTwoPassphrase;
const numberOfValidPhrases = require('./day4').numberOfValidPhrases;
...
describe('day 4', () => {
  describe('part 1', () => {
    ...
    it('final input', () => {
      expect(numberOfValidPhrases(`pphsv ojtou brvhsj cer ntfhlra udeh ccgtyzc zoyzmh jum lugbnk
...
juo pmiyoh xxk myphio ogfyf dovlmwm moevao qqxidn`, isValidPassphrase)).toBe(466);
    })
  });
  ...
  describe('Part 2', () => {
    describe('examples', () => {
      it('1', () => {
        expect(isValidPartTwoPassphrase('abcde fghij')).toBe(true);
      });

      it('2', () => {
        expect(isValidPartTwoPassphrase('abcde xyz ecdab')).toBe(false);
      });

      it('3', () => {
        expect(isValidPartTwoPassphrase('a ab abc abd abf abj')).toBe(true);
      })

      it('4', () => {
        expect(isValidPartTwoPassphrase('iiii oiii ooii oooi oooo')).toBe(true);
      })
...
cbok koumkad otpozb pqcs emilpe wpcyvxd bock
spjb xkkak anuvk ejoklh nyerw bsjp zxuq vcwitnd xxtjmjg zfgq xkpf
juo pmiyoh xxk myphio ogfyf dovlmwm moevao qqxidn`, isValidPartTwoPassphrase)).toBe(251);
    })
