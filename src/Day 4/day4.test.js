...
const finalInput = `pphsv ojtou brvhsj cer ntfhlra udeh ccgtyzc zoyzmh jum lugbnk
...
describe('day 4', () => {
  describe('part 1', () => {
    ...
    it('final input', () => {
      // expect(numberOfValidPhrases(finalInput, isValidPassphrase)).toBe(466);
    })
  });
  ...
  describe('Part 2', () => {
    ...
    it('final input', () => {
      // expect(numberOfValidPhrases(finalInput, isValidPartTwoPassphrase)).toBe(251);
    })
